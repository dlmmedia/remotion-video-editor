...
export const goldPriceChartCode = `import { useCurrentFrame, useVideoConfig, AbsoluteFill, spring } from "dlm-media";
...
export const goldPriceChartExample: DLMMediaExample = {
  id: "gold-price-chart",
